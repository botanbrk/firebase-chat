import {
  ...
  const Chat = ({ room, setRoom }) => {
    ...
    const handleSubmit = async (e) => {
      ...
      // koleksiyona yeni documetn (mesaj) ekleme
      ...
      e.target[0].value = ''; // formu temizle
  
    };
  
    useEffect(() => {
      // filtremeleme ayarları tanımlama
      ...
      // kolleksiyon her değiştiğinde fonksiyonu çalıştırır
      ...
      const unsubscribe = onSnapshot(queryOptions, (snapshot) => {
        ...
        // dökümanları dönüp doc içerisindeki 
      ...
      return () => {
        // kolleksiyonu izlemeyi durdurur
        unsubscribe();
      };
    }, [messagesCol, room]);
